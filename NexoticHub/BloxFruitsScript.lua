...
divider.Size = UDim2.new(0, 330, 0, 1)
...
showKeyButton.Size = UDim2.new(0, 24, 0, 24)
showKeyButton.Position = UDim2.new(1, -30, 0.5, -12)
showKeyButton.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
showKeyButton.TextColor3 = Color3.fromRGB(200, 200, 200)
showKeyButton.Text = "👁"
showKeyButton.Font = Enum.Font.Gotham
showKeyButton.TextSize = 14
showKeyButton.ZIndex = 2
showKeyButton.Parent = inputBox

local showKeyCorner = Instance.new("UICorner")
showKeyCorner.CornerRadius = UDim.new(0, 4)
showKeyCorner.Parent = showKeyButton
...
getKeyButton.Size = UDim2.new(0, 330, 0, 30)
getKeyButton.Position = UDim2.new(0, 10, 0, 160)
getKeyButton.BackgroundColor3 = Color3.fromRGB(80, 40, 140)
...
closeButton.Size = UDim2.new(0, 330, 0, 30)
...
statusLabel.Size = UDim2.new(0, 330, 0, 20)
...
buttonHoverEffect(submitButton, Color3.fromRGB(0, 120, 215), Color3.fromRGB(0, 140, 255))
buttonHoverEffect(getKeyButton, Color3.fromRGB(80, 40, 140), Color3.fromRGB(100, 60, 160))
buttonHoverEffect(closeButton, Color3.fromRGB(60, 60, 60), Color3.fromRGB(80, 80, 80))
buttonHoverEffect(showKeyButton, Color3.fromRGB(50, 50, 50), Color3.fromRGB(70, 70, 70))

local keyVisible = false
showKeyButton.MouseButton1Click:Connect(function()
    keyVisible = not keyVisible
    inputBox.TextTransparency = keyVisible and 0 or 0.5
    showKeyButton.Text = keyVisible and "👁" or "👁"
end)

local function validateKey()
    local enteredKey = inputBox.Text
    if enteredKey == "NexoticHubBloxFruitsHazolDev" then
        statusLabel.Text = "✅ Key accepted! Loading script..."
        statusLabel.TextColor3 = Color3.fromRGB(50, 255, 50)
        TweenService:Create(frame, TweenInfo.new(0.5), {Size = UDim2.new(0, 350, 0, 0)}):Play()
        wait(0.5)
        screenGui:Destroy()
        local MatsuneA1 = {};
...
_G.imageLogo = "rbxassetid://74631804810733"
_G.Logo = "rbxassetid://74631804810733"
...
ImageButton.Image = "rbxassetid://74631804810733"
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("https://discord.gg/3Rjr2y4UMw")
    wait(.1)
...
local function showNotification(message)
    ...
    notifyFrame.Position = UDim2.new(1, -260, 1, -80)
    ...
    notifyShadow.Size = UDim2.new(1, 12, 1, 12)
    notifyShadow.Position = UDim2.new(0, -6, 0, -6)
...
TweenService:Create(frame, TweenInfo.new(0.5), {Size = UDim2.new(0, 350, 0, 250)}):Play()
